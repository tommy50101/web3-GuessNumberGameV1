...
module.exports = {
  ...
  networks: {
    hardhat: {
      ...
      chainId: 5, // Force the ChainID to be 3 (Ropsten). Will come in handy during testing
      forking: {
        // Configure the forking behavior
        url: process.env.INFURA_GOERLI_API_URL, // Using the RPC_URL from the .env file
      },
    },
    ropsten: {
